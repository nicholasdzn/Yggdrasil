    ...
    return (
        <>
            <div className='flex flex-col h-screen'>
                <Header />
                <section className='flex flex-col sm:flex-row items-center justify-center pt-5 md:gap-[5rem] px-4 gap-10 pb-5 main-content flex-1'>
                    <div className='flex flex-col items-center sm:items-start justify-center order-last sm:order-1 max-w-[25rem] 2xl:max-w-[50rem] text-center sm:text-start'>
                        ...
                        <p className='pb-6 2xl:text-2xl '>Na plataforma Yggdrasil, unimos inovação e consciência ambiental,
                        ...
                        <button className='bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-blue-600 2xl:w-[15rem] 2xl:h-[4rem] 2xl:text-2xl 2xl:p-3 font-bold'>Descubra Mais</button>
                    </div>
                    <img src={Logo} alt="" className='w-[15rem] lg:w-[20rem] 2xl:w-[30rem] md:w-[18rem] order-1' />
                </section>
                <Footer />
            </div>
        </>
